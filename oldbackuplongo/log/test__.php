	...
	if (navigator.geolocation) {
		...
		var startPos;
  		...
  		var geoError = function(error) {
  			var message = "There has been an error getting the geolocation. ";
		  	message = message +  "The user is " + "<?php print $_SESSION['userName']; ?>. ";
		  	message = message + "The user agent is: " + "<?php print $_SERVER['HTTP_USER_AGENT']; ?>. ";
		  	if(error.code==0){
		  		message = message + "There cause of the error was unknown. ";
		  	}
		  	else if(error.code==1){
		  		message = message + "Permission by the user has been denied. ";
		  	}
		  	else if(error.code==2){
		  		message = message + "The position is unavialbe. ";
		  	}
			$.post('../php/mail.php', {message: message: message});
	 	}
