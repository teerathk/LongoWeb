...
if(isset($_SESSION['userName'])){
    ...
    if(isset($_POST['iscomment']) == "commentupdate"){
        ...
        $sql = "UPDATE jobs SET ecomments = '".$comments."', timestamp_end = NOW(), latitudeEnd = '".$lat."', longitudeEnd = '".$lng."', lastUpdated = NOW(), end_location = '".$formatted_address."' WHERE `jobId` = '".$lastid."' ";        
