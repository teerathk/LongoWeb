    ...
    <div class="container_12">	
        <div class="grid_12">
            <div class="pad-0 border-1">
                <h2 class="top-1 p0">Become a Vendor</h2>
                <p class="p2">We are looking for all types of tradesmen, including:</p>
                ...
                <p class="p2">
                	Vendors are paid in a timely manner, regardless of when we get paid. 
                	If you feel you offer a service that we would  find valuable, let us know by filling out the contact information.</p>
            </div>
            <?php
